            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>{{ json_decode($medone_content->content)->title }}<br>{{ json_decode($medone_content->content)->subtitle }}</h2>
                        <p>{{ json_decode($medone_content->content)->desc }}</p>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{ json_decode($medtwo_content->content)->title }}</h4>
                            <p>{{ json_decode($medtwo_content->content)->subtitle }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>{{ json_decode($medthree_content->content)->title }}</h4>
                            <p>{{ json_decode($medthree_content->content)->subtitle }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            ...
                            <h4>{{ json_decode($medfour_content->content)->title }}</h4>
                            <p>{{ json_decode($medfour_content->content)->subtitle }}</p>
                        </div>
                    </div>
                </div>
            </div>
